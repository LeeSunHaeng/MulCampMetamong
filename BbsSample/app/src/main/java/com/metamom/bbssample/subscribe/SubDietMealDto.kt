...
// subdfType = 타입
class SubDietMealDto(val subdfSeq:Int, val subdfTime:Int, val subdfImage:String?, val subdfName:String?, val subdfKcal:Int, val subdfAmount:Int, val subdfType:String?) :Parcelable {
